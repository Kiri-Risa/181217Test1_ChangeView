...
public class Controll : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Video3 = Plane3.GetComponent<Transform>();
        Video4 = Plane4.GetComponent<Transform>();
        NextObject = Next.GetComponent<Transform>();
        Player1 = Plane1.GetComponent<VideoPlayer>();
        Player2 = Plane2.GetComponent<VideoPlayer>();
        Player3 = Plane3.GetComponent<VideoPlayer>();
        Player4 = Plane4.GetComponent<VideoPlayer>();
        SW = 0;
        Player2.Pause();
        Player3.Pause();
        Player4.Pause();
